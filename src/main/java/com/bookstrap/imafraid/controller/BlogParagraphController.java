...
public class BlogParagraphController {
	...
	public BlogParagraph insert1(){
		...
		para1.setParagraphdiv01("童年的回憶何以能影響人一輩子，這部電影足以給人解答。\r\n"
				...
				+ "\r\n"
				+ "這部描述回憶的不確實，但仍將成年後的你645465465一網成擒，充滿了感官與身體的記憶回放，讓你感受到電影名「日麗」那年夏天淡淡的汗味，鹽味蒸發的海岸、看似無聊漫長最後卻一球入袋的假日、父親語焉不詳的笑容、周遭年輕人壯美卻聊賴的青春，其感官意象之豐盛，讓觀眾明確感受到主角雖正在經歷她的夏天，但同時又充滿了「回放」的後座力。\r\n"
				+ "\r\n"
