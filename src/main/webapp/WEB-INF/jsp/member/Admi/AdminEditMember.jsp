...
<%@ include file="/WEB-INF/jsp/backend/layout/sidebar/adminsidebar.jsp" %>
  ...
  <div class="wrapper">
        ...
        <br>
       <form class="needs-validation" action="${contextRoot}/admin/put/member?memberId=${member.memberId}" method="post" enctype="multipart/form-data">
                <div class="row g-3" novalidate>
                    <div class="col-sm-6">
                        ...
                        <input value="${memberDetail.memberLastName}" name="memberLastName" type="text" class="form-control" id="lastName" placeholder="請輸入姓氏" required/>
                       </spring:bind>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input value="${memberDetail.memberFirstName}" name="memberFirstName" type="text" class="form-control" id="firstName" placeholder="請輸入名字" required/>
                        </spring:bind>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-12">
                        ...
                        <input value="${memberDetail.memberEmail}" name="memberEmail" type="email" class="form-control bg-light" id="memberEmail" placeholder="請輸入電子信箱地址" required/>
                        </spring:bind>
                        <div class="invalid-feedback">
                            請輸入電子信箱地址
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <input value="${member.memberPassword} "name="memberPassword" type="password" class="form-control" id="memberPassword" placeholder="請輸入密碼" required/>
                        </spring:bind>
                        <div class="invalid-feedback">
                            請輸入密碼
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <input value="${member.memberPassword}" name="re_memberPassword" type="password" class="form-control" id="re_memberPassword" placeholder="確認密碼" required/>
                        <div class="invalid-feedback">
                            確認密碼
                        </div>
                    </div>
                    ...
                    <div class="col-12 ">
                        ...
                        <input value="${member.memberValid}" type="text" class="form-control" id="memberValid" name="memberValid" value="2"/>
                    	</spring:bind>
                    </div>

                    <div class="col-12 ">
                    	<spring:bind path="member.memberLevel">    
                        	<input value="${member.memberLevel}" type="text" class="form-control" id="memberLevel" name="memberLevel" value="1"/>
                    	</spring:bind>
                    </div>
                    <hr class="bg-white">
                    ...
                    <div class="col-12">
                       ...
                       <spring:bind path="memberDetail.memberPhone">
                        <input value="${memberDetail.memberPhone}" type="text" class="form-control" id="phone" placeholder="請輸入連絡電話" 
                    ...
                    <div class="col-12">
                        ...
                        <input value="${memberDetail.memberAddress}" type="text" name="memberAddress" class="form-control" id="address" placeholder="請輸入聯絡地址" required/>
                        </spring:bind>
                        <div class="invalid-feedback">
                            請輸入聯絡地址
                        </div>
                    ...
                    <div class="col-5">
                        ...
                        <input value="${memberDetail.memberBirthday}" type="date" class="form-control" id="birthdy" name="memberBirthday" required/>
                        </spring:bind>
                        <div class="invalid-feedback">
                            請選擇出生年月日
                        </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <select value="${memberDetail.memberSex}" class="form-select" id="gender" name="memberSex" required>
                    ...
                    <div class="col-5">
                        ...
                        <input value="${memberDetail.memberPhoto}" type="file" class="form-control" id="memberPhoto" name="memberPhoto"/>
                        </spring:bind>
                        <img src="${contextRoot}/admin/delete/member?memberId=${member.memberId}">
                        <div class="invalid-feedback">
                            請選擇大頭照
                        </div>
                    </div>
