      ...
      <div class="container">
        ...
        <div class="nav-scroller py-1 mb-2">
          <nav class="nav d-flex justify-content-between">
            ...
            <a class="p-2 link-secondary" href="#">新書推薦</a>
            <a class="p-2 link-secondary" href="#">好書指南</a>
      ...
      <main class="container">
        <div class="p-4 p-md-5 mb-4 rounded "
          ...
          <div class="col-md-6 px-0">
            <h1 class="display-4 text-light fw-bold" id="newParaTitle">最新文章</h1>
            <div id="box">

              <p style=color:white id="newParaContent"></p>
        ...
        <div class="row g-5">
          <div class="col-md-8">
            ...
            <article class="blog-post">
              <h2 class="blog-post-title mb-1">文章標題</h2>
            ...
            <article class="blog-post">
              <h2 class="blog-post-title mb-1">第二份文章</h2>
