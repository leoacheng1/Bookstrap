  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <%@ include file="../sidebarlinks/memberlinks.jsp" %>
        <%@ include file="../sidebarlinks/storelinks.jsp" %>
        <%@ include file="../sidebarlinks/ownerlinks.jsp" %>
        <%@ include file="../sidebarlinks/bloglinks.jsp" %> 
      </ul>
    </nav>
