...
<!-- <script src="http://localhost:8080/Bookstrap/eddie/js/jquery.min.js"></script> -->
<!-- <script src="http://localhost:8080/Bookstrap/js/bootstrap.bundle.min.js"></script> -->
<!-- <script src="http://localhost:8080/Bookstrap/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl"></script> -->
