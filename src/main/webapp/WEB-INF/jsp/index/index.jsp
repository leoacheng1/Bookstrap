    ...
    <div class="container-fluid d-flex mt-2 mb-2 justify-content-center ">
        ...
        <div class="container mt-5">
            ...
            <div class="shadow card mb-3 p-2 border border-2 border-opacity-25" style="max-width: 100%;">
                <div class="row g-0">
                    <div class="col-md-4">
                        <a href=""><img src="ad1/9782072940897-xs.webp" class="img-fluid rounded-start" alt="..."></a>
                    </div>
                    <div class="col-md-8">
                        <div class="card-body ">
                            ...
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
                                ...
                                Optio, praesentium deserunt. Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                Veritatis, animi. Excepturi similique magnam quae possimus explicabo aut odio qui libero
