...
<html>
  ...
  <body>
    ...
    <div
      class="container-fluid d-flex mt-2 justify-content-center border-bottom border-1"
    >
      <div class="top_search_table">
        <ul class="nav">
          <li class="nav-item">
            <a
              class="nav-link active-2 text-dark fs-5 me-5"
              aria-current="page"
              href="#"
              ><i class="fa-solid fa-location-dot"></i>分店位置
            </a>
          </li>
          <br />
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link b text-dark text-dark fs-5 me-5" href="#"
              >優惠資訊</a
            >
          </li>
          <li class="nav-item">
            <a class="nav-link text-dark text-dark fs-5 me-5" href="#"
              >當月熱銷</a
            >
          </li>
          <li class="nav-item">
    ...
    <div
      class="container-fluid p-3 mb-2 bg-custom text-white"
      style="height: 50px"
    >
    ...
    <div
      class="container mx-auto mt-5 border border-start-0 border-end-0 border-top-0"
    >
    ...
    <div class="container mt-3">
      <div
        class="second-carousel border border-end-0 border-start-0 border-top-0 mt-2"
      >
        <div class="slider">
          <a href="#" class="icon-text"
            ><img src="icon/medal.png" width="120px" class="mx-auto" />
            <p class="text-center">暢銷書籍</p>
          </a>
        </div>
        <div class="slider">
          <a href="#" class="icon-text"
            ><img src="icon/book.png" width="120px" class="mx-auto" />
            <p class="text-center">最新發行</p>
          </a>
        </div>
        <div class="slider">
          <a href="#" class="icon-text"
            ><img src="icon/audiobook.png" width="120px" class="mx-auto" />
            <p class="text-center">有聲書</p>
          </a>
        </div>
        <div class="slider">
          <a href="#" class="icon-text"
            ><img src="icon/coming-soon.png" width="120px" class="mx-auto" />
            <p class="text-center">即將上架</p>
          </a>
        </div>
        <div class="slider">
          <a href="#" class="icon-text"
            ><img src="icon/coupon.png" width="120px" class="mx-auto" />
            <p class="text-center">優惠資訊</p>
          </a>
        </div>
        <div class="slider">
          <a href="#" class="icon-text"
            ><img src="icon/pen-tool.png" width="120px" class="mx-auto" />
            <p class="text-center">特別精裝</p>
          </a>
        </div>
        <div class="slider">
          <a href="#" class="icon-text"
            ><img src="icon/gift.png" width="120px" class="mx-auto" />
            <p class="text-center">禮品</p>
          </a>
        </div>
      </div>
    </div>
      ...
      <nav>
        ...
        <div class="nav nav-tabs" id=" nav-tab" role="tablist">
          ...
          <button
            ...
            id="nav-t1i1-tab"
            data-bs-toggle="tab"
            data-bs-target="#nav-t1i1"
            type="button"
            role="button"
            aria-controls="nav-t1i1"
            aria-selected="true"
          >
            中文
          </button>
          <button
            ...
            id="nav-t1i2-tab"
            data-bs-toggle="tab"
            data-bs-target="#nav-t1i2"
            type="button"
            role="tab"
            aria-controls="nav-t1i2"
            aria-selected="false"
          >
            外文
          </button>
          <button
            ...
            id="nav-t1i3-tab"
            data-bs-toggle="tab"
            data-bs-target="#nav-t1i3"
            type="button"
            role="tab"
            aria-controls="nav-t1i3"
            aria-selected="false"
          >
            人氣小說
          </button>
          <button
            ...
            id="nav-t1i4-tab"
            data-bs-toggle="tab"
            data-bs-target="#nav-t1i4"
            type="button"
            role="tab"
            aria-controls="nav-t1i4"
            aria-selected="false"
          >
            雜誌新刊
          </button>
          <button
            ...
            id="nav-t1i5-tab"
            data-bs-toggle="tab"
            data-bs-target="#nav-t1i5"
            type="button"
            role="tab"
            aria-controls="nav-t1i5"
            aria-selected="false"
          >
            人氣小說
          </button>
          <button
            ...
            id="nav-t1i6-tab"
            data-bs-toggle="tab"
            data-bs-target="#nav-t1i6"
            type="button"
            role="tab"
            aria-controls="nav-t1i6"
            aria-selected="false"
          >
            創意生活
          </button>
      ...
      <nav>
        ...
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          ...
          <button
            ...
            id="nav-t2i1-tab"
            data-bs-toggle="tab"
            data-bs-target="#nav-t2i1"
            type="button"
            role="button"
            aria-controls="nav-t2i1"
            aria-selected="true"
          >
            中文
          </button>
          <button
            ...
            id="nav-t2i2-tab"
            data-bs-toggle="tab"
            data-bs-target="#nav-t2i2"
            type="button"
            role="tab"
            aria-controls="nav-t2i2"
            aria-selected="false"
          >
            外文
          </button>
          <button
            ...
            id="nav-t2i3-tab"
            data-bs-toggle="tab"
            data-bs-target="#nav-t2i3"
            type="button"
            role="tab"
            aria-controls="nav-t2i3"
            aria-selected="false"
          >
            人氣小說
          </button>
          <button
            ...
            id="nav-t2i4-tab"
            data-bs-toggle="tab"
            data-bs-target="#nav-t2i4"
            type="button"
            role="tab"
            aria-controls="nav-t2i4"
            aria-selected="false"
          >
            雜誌新刊
          </button>
          <button
            ...
            id="nav-t2i5-tab"
            data-bs-toggle="tab"
            data-bs-target="#nav-t2i5"
            type="button"
            role="tab"
            aria-controls="nav-t2i5"
            aria-selected="false"
          >
            人氣小說
          </button>
          <button
            ...
            id="nav-t2i6-tab"
            data-bs-toggle="tab"
            data-bs-target="#nav-t2i6"
            type="button"
            role="tab"
            aria-controls="nav-t2i6"
            aria-selected="false"
          >
            創意生活
          </button>
    ...
    <div class="container">
      ...
      >
        <p class="float-right justify-content-center">
          ...
          9:00~18:00，365天全年無休 博客來數位科技股份有限公司 統編 : 96922355
